...
- `~/BOILER-WG110-day5-candidate.mspdi.xml` custom-field aliases give the **site link convention**: `Text4 = "Work Order No."` (e.g. `WO6899500`), `Text5 = "Operation No."` (`10`), `Text15 = "Operation Description"`, `Text11 = "Work Group"`, `Text30 = "Assigned Department"`. Task UID 43 in that file is a live specimen of the disproved 3-field state.
