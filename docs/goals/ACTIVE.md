...
‡ the clean controlled baseline/repeat pair lives outside the repository; current post-RC02 production replay has 147 engine/source field mismatches across 39 leaves (144 RC01 and 3 RC03), so P1-G2 remains open; set `STO_REQUIRE_CONTROLLED_NATIVE_REPEAT=1` to make their absence a failure rather than a skip.
